...
export default class Mobile {
   ...
   * @param  { Game } theGame    the current state of the game
   */
  constructor(x, y, imgSrc, shiftX = 0, shiftY = 0, theGame) {
    this.y = y;
    this.x = x;
    this.img = new Image();
    this.img.src = imgSrc;
  ...
  */
  ...
  /** @return {number} the , ie. its images's height */
  get x2() {
    return this.img.width + this.x;
  }

  /** @return {number} the width of the mobile, ie. its images's width */
  get y2() {
    return this.img.height + this.y;
  }
}
